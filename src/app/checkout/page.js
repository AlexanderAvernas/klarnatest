            ...
            const response = await fetch('/api/klarna-order', {
                ...
                body: JSON.stringify({
                    ...
                    merchant_urls: {
                        ...
                        confirmation:
                            'https://klarnatest.netlify.app/confirmation?order_id={checkout.order.id}', // Dynamic Confirmation URL
                        push: 'https://klarnatest.netlify.app/api/push' // Push notification URL
                    }
                })
            })
